...
class Agent():
    ...
    def choose_action(self, observation):
        ...
        state = state.to(dtype=T.float, device=self.actor_critic.device)
    ...
    def learn(self, state, reward, state_, done):
        ...
        state_ = state_.to(dtype=T.float, device=self.actor_critic.device)

        reward = T.tensor(reward)
        reward = reward.to(dtype=T.float, device=self.actor_critic.device)
